    ...
    const initializeSafeAndSdk = async () => {
      ...
      try {
        ...
        if (safeAddress) {
          ...
          if (pkAccount) {
            runner = new SafeSdkPrivateKeyContractRunner(pkAccount.privateKey, 'https://staging.circlesubi.network/');
          ...
          if (pkAccount) {
            const rpcProvider = new JsonRpcProvider('https://staging.circlesubi.network/');
