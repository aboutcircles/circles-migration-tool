...
export function Dashboard({ address }: { address: Address }) {
        ...
        return (
            <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-6">
                <div className="animate-pulse">
                    <div className="h-8 bg-base-300 rounded-box w-48 mb-6"></div>
                    <div className="bg-base-100 rounded-box shadow-lg p-6 space-y-4">
    ...
    return (
        <div className="max-w-4xl w-full mx-auto p-2 sm:p-4 space-y-6">
            {showStepper && (
            ...
            {canGoBack && (
                <button
                    onClick={popState}
                    className="btn btn-sm btn-ghost gap-2 mb-0 sm:mb-4"
                >
